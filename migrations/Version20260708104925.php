 ...
 */
final class Version20260708104925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, consumer_id INT NOT NULL, business_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64937FDBD6D (consumer_id), UNIQUE INDEX UNIQ_8D93D649A89DB457 (business_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
